...
<script>
	...
	window.onload = function() {
		...
		xhr1.open("GET", "<c:url value='/ForumBeanUpdatePrepare'/>", true);
	...
	function mm() {
		...
		var xhr1 = new XMLHttpRequest();
		xhr1.open("POST", "UpdateForumServlet", true);

		xhr1.setRequestHeader("Content-Type",
				"application/x-www-form-urlencoded");
		xhr1.send("Content=" + rc);
		console.log("105");
					...
					<div style="margin: 0px auto; width: 650px" class="entry">
						...
						<div id="mId" class="name">
							...
							<div id="mNN" class="name">
								...
								<form name="form1" action="<c:url value='/UpdateForumServlet'/>"
									enctype="application/x-www-form-urlencoded" method="post">
									<textarea name="Content" id="rc"
