            ...
            <div class="product__details__pic">
              <div class="product__details__pic__item">
                <img
                  ...
                  src="up_NoUsed/${searchmemberImageFileName}" />
              </div>
            </div>
          </div>
          <div class="col-lg-6 col-md-6">
            <div class="product__details__text">
              <h3><font color="black">${searchmemberNickName}</font></h3>
              <div class="frienddata">
               		 性別:
                <div class="datacontent">${searchmemberGender}</div>
              </div>
              <div class="frienddata">
                	遊戲偏好:
                <div class="datacontent">${searchtypeName}</div>
              </div>
              <div class="frienddata">
               		 信箱:
                <div class="datacontent">${searchmemberMail}</div>
              </div>
              <br/> 
				<form action="<c:url value='/FriendsInsert.do'/>" method="post"
					enctype="multipart/form-data">
					<div class="input-group mg-b-pro-edt">
						<input type="text" name="memID" class="form-control" value="${memberID}" style="display:none"/>
					</div>
					<div class="input-group mg-b-pro-edt">
						<input type="text" name="friID" class="form-control" value="${searchmemberID}"  style="display:none"/>
					</div>
					<button type="submit" name="Submit" class="primary-btn" >
						<i class="fa fa-plus"></i>加入好友
					</button>
					<p>
						<span>${InsertMsg}</span>
					</p>
