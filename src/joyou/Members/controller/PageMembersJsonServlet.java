...
@WebServlet("/PageMembersJsonServlet.do")
@javax.servlet.annotation.MultipartConfig
public class PageMembersJsonServlet extends HttpServlet
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (type.equals("all"))
		{
			members = mDao.selectByPage(pageNo);

		}
		PrintWriter out = response.getWriter();

		Gson gs = new Gson();
		String jsonMembers = gs.toJson(members);
